...
let proc = `${wapi} *(random/aleatory)*`;
let random = `\t\t〤  *R A N D O M*
...
let cristiano = `\t\t〤  *R A N D O M*

⩩ *Imagenes* » 18 results
⩩ *Random* » Cristiano Ronaldo
⩩ *API* » ${proc}
...
let pruebaXd = `📍  Objetivo no valido, usa *${usedPrefix + command}* para buscar el resultado.`;
