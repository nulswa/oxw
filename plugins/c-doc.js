...
if (!m.quoted) return conn.sendMessage(m.chat, { text: `ᗢ Responda a un audio o video.\n- Proporciona un nombre al archivo.\n\n${mssg.ejemplo}\n*${usedPrefix + command}* toru` }, { quoted: m })
if(!text) return conn.sendMessage(m.chat, { text: `ᗢ Responda a un audio o video.\n- Proporciona un nombre al archivo.\n\n${mssg.ejemplo}\n*${usedPrefix + command}* toru` }, { quoted: m })
