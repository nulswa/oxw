...
throw new Error('No se pudo guardar la foto de perfil en el archivo target.json.');
}
}
...
if (!global.db.data.chats[m.chat].fTarget && m.isGroup) {
return conn.sendMessage(m.chat, { text: `*[ ⽷ ]*  Este comando no puede estar habilidado.\n- Solo es exclusivo para cuentas de empresa en argentina.` }, { quoted: m });
};
...
await conn.reply(usuario, mensaje, m);
