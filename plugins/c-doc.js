...
if (!m.quoted) return conn.sendMessage(m.chat, { text: `ᗢ Responda a un audio o video para convertirlo en documento.\n\n\t⚶ Por ejemplo:\n*${usedPrefix + command}* toru` }, { quoted: m })
if(!text) return conn.sendMessage(m.chat, { text: `ᗢ Texto faltante, ingrese el nombre del documento.\n\n\t⚶ Por ejemplo:\n*${usedPrefix + command}* toru` }, { quoted: m })
if (!/audio|video/.test(mime)) return conn.sendMessage(m.chat, { text: `Solo puedes responder videos o audios...` }, { quoted: m })
