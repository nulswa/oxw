...
m.react('⏰');
let api = `https://api.delirius.store/tools/htmlextract?url=${args[0]}`;
...
//let paginaHtml = `${data}`
//m.react('✅');
await conn.sendMessage(m.chat, { text: infoHtml.trim(), contextInfo: { externalAdReply: { title: botname, body: textbot, thumbnail: thumb, sourceUrl: null, mediaType: 1, renderLargerThumbnail: false }}}, { quoted: m });
};
