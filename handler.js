...
this.sendMessage(id, { text: text, contextInfo: { forwardingScore: 9999999, isForwarded: true, mentionedJid: [user], externalAdReply: { showAdAttribution: true, renderLargerThumbnail: true, thumbnail: apii.data, title: botname, containsAutoReply: true, mediaType: 1, sourceUrl: null } } }, {quoted: null})
apii.data = ''
}
}
}
...
nk.from,
`Hola usuario. *@${nk.from.split('@')[0]}*, seras bloqueado por hacer una ${nk.isVideo ? 'video llamada' : 'llamada'} en este chat.`,
false,
{mentions: [nk.from]}
)
